 ...
 */
module.exports = function error(code, codes, message, parameters) {
  ...
  this.emit(
    'exception', code, codes, msg, replacements, parameters);
  //console.dir('retval %j', result);
  var exit = true;
  if(this._error) {
    exit = this._error.call(
      this, code, codes, msg, replacements, parameters);
  }else if(msg){
