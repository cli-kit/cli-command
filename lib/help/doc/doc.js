...
HelpDocument.prototype.getSection = function(data, key) {
  ...
  if(conf && conf.help && conf.help.sections
    && conf.help.sections[key]) {
      //console.log('get section returning on %s', key);
      //console.dir(conf.help.sections[key]);
    return conf.help.sections[key];
  }
